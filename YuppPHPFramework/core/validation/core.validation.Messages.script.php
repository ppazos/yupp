...
$m->a( "validation.error.datetime",            "es", "El valor '{0}' del atributo '{1}' no es una fecha y tiempo valida" );
...
$m->a( "validation.error.datetime",            "en", "Value '{0}' of attribute '{1}' is not a valid datetime" );
