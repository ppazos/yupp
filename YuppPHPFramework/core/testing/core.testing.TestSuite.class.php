...
#8  RequestManager::doRequest() called at [C:\wamp\www\YuppPHPFramework\index.php:94]
          ...
          */
           ...
           //$this->reports[] = $e->getMessage() .': '. $trace;
           $this->report('EXCEPTION', $e->getMessage(), $trace);
        }
      }
   }
   
   public function report($type, $msg, $trace = '')
   {
      $this->reports[] = array('type'=>$type, 'msg'=>$msg, 'trace'=>$trace);
   }
